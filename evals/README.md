...
python3 scripts/run_evals.py run \
  --runner claude \
  --condition candidate \
  --condition-skill skills/meini-style/SKILL.md \
  --trials 3 \
  --budget-usd 12.50 \
  --output evals/results/responses.jsonl
```
